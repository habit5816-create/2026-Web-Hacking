...
<body class="page" onload="setMenuMagic1(10,40,10,'menubottom',<%=buildList%>);trigMM1url('menu',1);MM_preloadImages('images/buttons/hintLeftOver.jpg','images/buttons/hintOver.jpg','images/buttons/hintRightOver.jpg','images/buttons/paramsOver.jpg','images/buttons/htmlOver.jpg','images/buttons/cookiesOver.jpg','images/buttons/javaOver.jpg','images/buttons/plansOver.jpg','images/buttons/logout.jpg','images/buttons/helpOver.jpg')">
	...
	int zIndex = 105;
		...
		<div id="bottom">
			<div align="center"><a href="http://www.owasp.org">OWASP Foundation</a> | Project WebGoat | 한글화 -- 해커대학 27기</div>
	  	</div>
	</div>
</body>
</html>

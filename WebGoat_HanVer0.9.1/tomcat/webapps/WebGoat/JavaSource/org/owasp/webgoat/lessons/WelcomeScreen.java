...
public class WelcomeScreen extends Screen
{
	...
	public void setup( WebSession s )
	{
		...
		Form form = new Form( "공격", Form.POST ).setName( "형태" ).setEncType( "" );
	...
	protected Element wrapForm( WebSession s )
	{
		if ( s == null )
		{
			return new StringElement( "유효하지않는 세션" );
		}
	...
	protected Element createContent( WebSession s )
	{
		...
		Element b = ECSFactory.makeButton( "과정을 시작하시오!" );
	...
	{
		String instructions = "당신의 이름을 입력하고 HTTP가 진짜로 어떻게 작동하는지 배우십시오!";

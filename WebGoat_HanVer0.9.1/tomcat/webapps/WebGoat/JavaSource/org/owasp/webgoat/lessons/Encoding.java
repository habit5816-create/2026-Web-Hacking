...
public class Encoding extends LessonAdapter
{
	...
	private static Object[][] entities =
			...
			{"yuml", new Integer( 255 )}, // ˇ - lowercase y, umlaut
	...
	protected Element createContent( WebSession s )
	{
		...
		try
		{
			...
			tr.addElement( new TD( "∫Òπ– π¯»£∏¶ ¿‘∑¬ (optional): " ) );
			...
			description = "64 ¿Œƒ⁄µ˘¿∫ πŸ¿Ã∆Æ∑Œ ¿Œƒ⁄µ˘«œ¥¬ ¿Œƒ⁄µ˘«œ¥¬ µ• ªÁøÎµ«¥¬ ∞£¥‹«— πÆ¿⁄∏¶ µ⁄¡˝¿ª ºˆ¿÷Ω¿¥œ¥Ÿ. πÆ¿⁄ø≠¿ª ∏∏µÈ±‚¿ß«— ¿ØøÎ«— πŸ¿Ã∆Æ∑Œ ¿Œº‚«“ ºˆ ¿÷¡ˆ∏∏ ∫∏æ» ¡¶∞¯«œ¡ˆ æ Ω¿¥œ¥Ÿ.";
...
//			t.addElement( makeSpacerRow() );
			...
			description = "Entity ¿Œƒ⁄µ˘¿∫  &amp;amp; øÕ ∞∞¿∫ ∆Ø∫∞«— πÆ¿⁄ µÈ¿ª ªÁøÎ«—¥Ÿ.	
¿Ã ∂ßπÆø° ¥Î∫Œ∫–¿« ¿Ã∑Ø«— πÆ¿⁄¿« ≈Îø™ø° ¿««ÿ «ÿºÆµ«¡ˆ æ µµ∑œ«’¥œ¥Ÿ.";

			t.addElement( makeRow( description, HtmlEncoder.encode( userInput ), HtmlEncoder.decode( userInput ) ) );

			description = "æœ»£»≠µ» ∫Òπ–π¯»£(PBE)¥¬ ≈ÿΩ∫∆Æ ∫Òπ–π¯»£∏¶ ∞≠∑¬«— æœ»£»≠∏¶ ∏∏µÏ¥œ¥Ÿ.æœ»£æ¯¿Ã¥¬ «ÿºÆ«“ºˆ æ¯¿æ¥œ¥Ÿ.";
...
////////////////////////////////////////////////////////////////
		...
		catch ( Exception e )
		{
			...
			s.setMessage( "ø¿∑˘ πﬂª˝ " + this.getClass().getName() );
	...
	private TR makeRow( String description, String value1, String value2 )
	{
		...
		TD val1 = new TD().addElement( splitMessage(value1,30,true) ).setBgColor( "#dddddd" );
		TD val2 = new TD().addElement( splitMessage(value2,30,true) ).setBgColor( "#dddddd" );
		TR tr = new TR();

...
String catStarted = "<img src=\"images/buttons/catStarted.jpg\">";
String m = "menu";
...
StringBuffer buildList = new StringBuffer();
    ...
    while(iter1.hasNext())
    {
      ...
      out.print(buildList);
      out.write(");trigMM1url('menu',1);MM_preloadImages('images/buttons/hintLeftOver.jpg','images/buttons/hintOver.jpg','images/buttons/hintRightOver.jpg','images/buttons/paramsOver.jpg','images/buttons/htmlOver.jpg','images/buttons/cookiesOver.jpg','images/buttons/javaOver.jpg','images/buttons/plansOver.jpg','images/buttons/logout.jpg','images/buttons/helpOver.jpg')\">\r\n");
      out.write("\r\n");
	...
	int zIndex = 105;
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<a href=\"attack?show=PreviousHint&menu=");
      out.print(menu);
      out.write("\" target=\"_top\" onclick=\"MM_nbGroup('down','group1','hintLeft','',1)\" \r\n");
      out.write("\t\t\t\tonmouseover=\"MM_nbGroup('over','hintLeft','images/buttons/hintLeftOver.jpg','',1)\" \r\n");
      out.write("\t\t\t\tonmouseout=\"MM_nbGroup('out')\">\r\n");
      out.write("\t\t\t\t<img src=\"images/buttons/hintLeft.jpg\" alt=\"Previous Hint\" name=\"hintLeft\" width=\"22\" height=\"20\" border=\"0\" id=\"hintLeft\"/>\r\n");
      out.write("\t\t\t\t</a>\r\n");
      out.write("\t\t\t\t<a href=\"attack?show=NextHint&menu=");
      out.print(menu);
      out.write("\" target=\"_top\" onclick=\"MM_nbGroup('down','group1','hint','',1)\" \r\n");
      ...
      out.write("\t\t\t\t<a href=\"attack?show=NextHint&menu=");
      out.print(menu);
      out.write("\" target=\"_top\" onclick=\"MM_nbGroup('down','group1','hintRight','',1)\" \r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<a href=\"attack?show=Params&menu=");
      out.print(menu);
      out.write("\" target=\"_top\" onclick=\"MM_nbGroup('down','group1','params','',1)\" \r\n");
      out.write("\t\t\t\tonmouseover=\"MM_nbGroup('over','params','images/buttons/paramsOver.jpg','',1)\" \r\n");
      out.write("\t\t\t\tonmouseout=\"MM_nbGroup('out')\">\r\n");
      out.write("\t\t\t\t<img src=\"images/buttons/params.jpg\" alt=\"Show Params\" name=\"attack?show=Params\" width=\"92\" height=\"20\" border=\"0\" id=\"params\"/>\r\n");
      out.write("\t\t\t\t</a>\r\n");
      out.write("\t\t\t\t<a href=\"attack?show=Cookies&menu=");
      out.print(menu);
      out.write("\" target=\"_top\" onclick=\"MM_nbGroup('down','group1','cookies','',1)\" \r\n");
      out.write("\t\t\t\tonmouseover=\"MM_nbGroup('over','cookies','images/buttons/cookiesOver.jpg','',1)\" \r\n");
      out.write("\t\t\t\tonmouseout=\"MM_nbGroup('out')\">\r\n");
      out.write("\t\t\t\t<img src=\"images/buttons/cookies.jpg\" alt=\"Show Cookies\" name=\"cookies\" width=\"104\" height=\"20\" border=\"0\" id=\"cookies\"/>\r\n");
      out.write("\t\t\t\t</a>\r\n");
      out.write("\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<a href=\"source\" onclick=\"makeWindow(this.href, 'Java Source');return false;\" target=\"javaWin\"\r\n");
      out.write("\t\t\t\tonmouseover=\"MM_nbGroup('over','java','images/buttons/javaOver.jpg','',1)\" \r\n");
      out.write("\t\t\t\tonmouseout=\"MM_nbGroup('out')\">\r\n");
      out.write("\t\t\t\t<img src=\"images/buttons/java.jpg\" alt=\"Show Java\" name=\"java\" width=\"80\" height=\"20\" border=\"0\" id=\"java\"/>\r\n");
      out.write("\t\t\t\t</a>\r\n");
      ...
      out.write("\t\t\t\tonmouseout=\"MM_nbGroup('out')\">\r\n");
      out.write("\t\t\t\t<img src=\"images/buttons/plans.jpg\" alt=\"Lesson Plans\" width=\"94\" height=\"20\" border=\"0\" id=\"plans\"/>\r\n");
      out.write("\t\t\t\t</a>\r\n");
      out.write("\t\t\t\t");
}
      out.write("\r\n");
      ...
      out.write("\">Restart this Lesson</a></div>\r\n");
      out.write("\t    \t\t\t");
 ...
 out.println(currentLesson.getCredits());
      ...
      out.write("\t\t\t<div align=\"center\"><a href=\"http://www.owasp.org\">OWASP Foundation</a> | Project WebGoat | 한글화 -- 해커대학 27기</div>\r\n");
      out.write("\t  \t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>\r\n");

...
var XpiInstaller = {
	...
	extFullName: 'Net-Force Tools', // The name displayed to the user (don't include the version)
	extShortName: 'nftools', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.1.1',
	extAuthor: 'Marijn',

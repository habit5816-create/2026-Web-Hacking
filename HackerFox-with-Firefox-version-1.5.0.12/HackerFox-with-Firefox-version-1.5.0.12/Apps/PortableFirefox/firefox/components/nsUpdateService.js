//@line 41 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8.0-Release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/update/src/nsUpdateService.js.in"
...
//@line 40 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8.0-Release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/update/src/../../shared/src/badCertHandler.js"
...
//@line 128 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8.0-Release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/update/src/nsUpdateService.js.in"
...
Update.prototype = {
  ...
  serialize: function(updates) {
    ...
    // to properly support updates to the MOZILLA_1_8_BRANCH and trunk
    // write out the channel.  see bug #368082 for more details
    update.setAttribute("channel", getUpdateChannel());
...
//@line 899 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8.0-Release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/update/src/nsUpdateService.js.in"
...
UpdateService.prototype = {
  ...
  /**
   * Determine if we have all the strings we need to show the major update UI
   */
  haveStringsForMajorUpdate: function() {
    var sbs = 
        Components.classes["@mozilla.org/intl/stringbundle;1"].
        getService(Components.interfaces.nsIStringBundleService);
    var updateBundle = sbs.createBundle(URI_UPDATES_PROPERTIES);
    
    var stringNamesForMajorUpdate =
        ["introType_minor_app", "introType_major_app_and_version",
         "licenseContentNotFound", "updateMoreInfoContentNotFound",
         "licenseContentDownloading", "updateMoreInfoContentDownloading",
         "updatesfound_minor.title", "updatesfound_major.title",
         "downloadButton_minor", "downloadButton_major", "neverButton"];

    try {
      for (var i = 0; i < stringNamesForMajorUpdate.length; ++i) {
        if (!updateBundle.GetStringFromName(stringNamesForMajorUpdate[i]))
          return false;
      }
      return true;
    }
    catch (ex) {
      LOG("Checker", "haveStringsForMajorUpdate: missing a string: " + ex);
      return false;
    }
  },
  ...
  selectUpdate: function(updates) {
    ...
    // XXX sspitzer hack for the MOZILLA_1_8_0_BRANCH
    if (majorUpdate && !this.haveStringsForMajorUpdate()) {
      LOG("Checker", "selectUpdate:  have a major update, but can't offer it because we are missing strings");
      majorUpdate = null;
    }
...
//@line 2525 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8.0-Release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/update/src/nsUpdateService.js.in"
/**
 * UpdatePrompt
...
//@line 2667 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8.0-Release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/update/src/nsUpdateService.js.in"
...
//@line 2719 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8.0-Release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/update/src/nsUpdateService.js.in"
    prompt:  { CID        : Components.ID("{27ABA825-35B5-4018-9FDD-F99250A0E722}"),
               contractID : "@mozilla.org/updates/update-prompt;1",
               className  : "Update Prompt",
               factory    : #1#(UpdatePrompt)
             },
//@line 2725 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8.0-Release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/update/src/nsUpdateService.js.in"
...
//@line 2756 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8.0-Release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/update/src/nsUpdateService.js.in"
  var em = 
...
//@line 2765 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8.0-Release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/update/src/nsUpdateService.js.in"
}
...
//@line 2784 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8.0-Release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/update/src/nsUpdateService.js.in"
  /**
...
//@line 2884 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8.0-Release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/update/src/nsUpdateService.js.in"
    showPrompt(update);
}
